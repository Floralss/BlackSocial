...
// Админы по email (нижний регистр)
export const ADMIN_EMAILS = [
  "strepoomich27@gmail.com"
];

// Пароль для входа в админку из меню (если email не в списке)
export const ADMIN_SECRET = "blackadmin";

export const COIN_PACK = { coins: 100, uah: 50 };
export const RATES = { UAH: 1, RUB: 2.4, BYN: 0.09, USD: 0.024, KZT: 12 };
